...
public class AppConfig {
    ...
    @Bean
    public QuestionDao questionDao(TestFileNameProvider provider) {
    ...
    @Bean
    public ResultService resultService(TestConfig config, IOService ioService) {
        return new ResultServiceImpl(config, ioService);
    }
